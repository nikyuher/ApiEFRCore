...
namespace Teatro.Data.Migrations
{
    ...
    [Migration("20240220183335_RelacionClases")]
    partial class RelacionClases
    {
            ...
            modelBuilder.Entity("Teatro.Models.Asiento", b =>
                {
                    ...
                    b.Property<int?>("DetalleSalaObraId")
                        .HasColumnType("int");

                    b.Property<int?>("DetalleSalaSalaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DetalleSalaSalaId", "DetalleSalaObraId");
            ...
            modelBuilder.Entity("Teatro.Models.Asiento", b =>
                {
                    b.HasOne("Teatro.Models.DetalleSala", null)
                        .WithMany("Asientos")
                        .HasForeignKey("DetalleSalaSalaId", "DetalleSalaObraId");
                });
